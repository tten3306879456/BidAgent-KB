...
1. **创建 ima 共享知识库**
   ...
   - 建议按类别创建 4~5 个库：
     ...
     | 核工业标书知识库 | 核工程/放射防护/核级设备项目 | 核工业标书知识库_种子版.md |
     | 软件开发标书知识库 | 信息化/软件定制/系统集成项目 | 软件开发标书知识库_种子版.md |
...
本项目维护以下 ima 共享知识库，社区用户可加入后直接检索：

### 已建成的领域知识库

| 共享知识库 | 知识库 ID | 内容 | 状态 |
|-----------|----------|------|------|
| ☢️ 核工业标书知识库 | `7493159651146811` | HAF 法规、GBZ117 放射防护、核级软件标准、资质等效规则、行业废标模式 | ✅ 种子已入库 |
| 💻 软件开发标书知识库 | `7493159953137267` | GB/T 8567、GB/T 25000.51、CMMI、ISO27001、ITSS、行业废标模式 | ✅ 种子已入库 |

### 计划中的通用知识库

| 共享知识库 | 内容 | 状态 |
|-----------|------|------|
| 📜 法律法规库 | 招标投标法、政府采购法、报价规则等 | 待创建 |
| ⚠️ 废标条款模式库 | 15条废标识别模式，持续积累 | 待创建 |
| 📝 标书模板/范文 | 脱敏后的标书范文片段 | 待创建 |
